...
当前清单中 7-Zip、Snipaste、Typora、Git、Visual Studio Code、Notepad++、FFmpeg、CC Switch、ngrok、MySQL、DBeaver、nginx、Clash Verge Rev、NVM 和 Python 使用 `Exact`；Google Chrome、Bing Wallpaper、Fences 6 和 Focus 10 使用 `Default`。MySQL 使用 Oracle 官方的 `Oracle.MySQL` 包，DBeaver 使用社区版 `DBeaver.DBeaver.Community` 包。Bing Wallpaper 使用 Microsoft Store 当前官方包 `XPFP7F8RL7MB1W`；安装时仍需能够访问微软提供的下载地址。当前没有需要 `Root` 的软件。
